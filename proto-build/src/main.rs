...
fn compile_sdk_protos_and_services(out_dir: &Path) {
    ...
    tonic_build::configure()
        ...
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.request_begin_block", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.response_begin_block", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.request_end_block", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.response_end_block", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.response_commit", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.DeliverTx.request", "#[serde(skip)]")
        .field_attribute(".cosmos.base.store.v1beta1.BlockMetadata.DeliverTx.response", "#[serde(skip)]")
