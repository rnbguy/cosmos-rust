...
const IMPL_MESSAGE_SERDE_FOR_CLIENT_STATE: () = {
    ...
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.ClientState")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ClientState" , decoder : | buf : & [u8] | { let msg : ClientState = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_CONSENSUS_STATE: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.ConsensusState")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ConsensusState" , decoder : | buf : & [u8] | { let msg : ConsensusState = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_HEADER: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.Header")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.Header" , decoder : | buf : & [u8] | { let msg : Header = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_MISBEHAVIOUR: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.Misbehaviour")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.Misbehaviour" , decoder : | buf : & [u8] | { let msg : Misbehaviour = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_SIGNATURE_AND_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.SignatureAndData")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.SignatureAndData" , decoder : | buf : & [u8] | { let msg : SignatureAndData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_TIMESTAMPED_SIGNATURE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.TimestampedSignatureData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.TimestampedSignatureData" , decoder : | buf : & [u8] | { let msg : TimestampedSignatureData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_SIGN_BYTES: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.SignBytes")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.SignBytes" , decoder : | buf : & [u8] | { let msg : SignBytes = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_HEADER_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.HeaderData")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.HeaderData" , decoder : | buf : & [u8] | { let msg : HeaderData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_CLIENT_STATE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.ClientStateData")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ClientStateData" , decoder : | buf : & [u8] | { let msg : ClientStateData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_CONSENSUS_STATE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.ConsensusStateData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ConsensusStateData" , decoder : | buf : & [u8] | { let msg : ConsensusStateData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_CONNECTION_STATE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.ConnectionStateData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ConnectionStateData" , decoder : | buf : & [u8] | { let msg : ConnectionStateData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};

#[allow(dead_code)]
const IMPL_MESSAGE_SERDE_FOR_CHANNEL_STATE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(name = "/ibc.lightclients.solomachine.v1.ChannelStateData")]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.ChannelStateData" , decoder : | buf : & [u8] | { let msg : ChannelStateData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_PACKET_COMMITMENT_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.PacketCommitmentData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.PacketCommitmentData" , decoder : | buf : & [u8] | { let msg : PacketCommitmentData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_PACKET_ACKNOWLEDGEMENT_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.PacketAcknowledgementData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.PacketAcknowledgementData" , decoder : | buf : & [u8] | { let msg : PacketAcknowledgementData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_PACKET_RECEIPT_ABSENCE_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.PacketReceiptAbsenceData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.PacketReceiptAbsenceData" , decoder : | buf : & [u8] | { let msg : PacketReceiptAbsenceData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
...
const IMPL_MESSAGE_SERDE_FOR_NEXT_SEQUENCE_RECV_DATA: () = {
    use ::prost_wkt::typetag;
    #[typetag::serde(
        name = "/ibc.lightclients.solomachine.v1.NextSequenceRecvData"
    )]
    ...
    ::prost_wkt::inventory::submit! { :: prost_wkt :: MessageSerdeDecoderEntry { type_url : "/ibc.lightclients.solomachine.v1.NextSequenceRecvData" , decoder : | buf : & [u8] | { let msg : NextSequenceRecvData = :: prost :: Message :: decode (buf) ? ; Ok (:: std :: boxed :: Box :: new (msg)) } } }
};
